...
const NavbarComponent = ({openDrawer, isDrawerOpen}) => {
    ...
    return (
        <Navbar className="w-full px-0 py-2 lg:px-4 lg:py-4 sticky top-2">
            <div className="flex items-center justify-between text-blue-gray-900 ">
                {/* <div className="flex w-full justify-start items-start sticky top-0"> */}
                ...
                <Typography
                    as="a"
                    href="#"
                    className="mr-4 cursor-pointer py-1.5 font-medium text-xl lg:text-xl"
                >
                    YTube
                </Typography>
