...
import { CubeTransparentIcon, UserCircleIcon, CodeBracketSquareIcon, Square3Stack3DIcon, ChevronDownIcon, Cog6ToothIcon, InboxArrowDownIcon, LifebuoyIcon, PowerIcon, RocketLaunchIcon, Bars2Icon } from "@heroicons/react/24/solid";
        ...
        },
        {
            ...
            action: async () => {
                try {
                    ...
                    const token = localStorage.getItem("accessToken"); // or get from Redux store
                    console.log("token from signout ", token);
                    const response = await postRequest(
                        ...
                        {},
                        {
                            headers: {
                                ...
                                Authorization: `Bearer ${token}`, // Ensure token is sent in the request
                            },
...
const ComplexNavbar = ({ openDrawer, isDrawerOpen }) => {
    ...
    return (
        <Navbar className=" max-w-full p-2 lg:rounded-lg lg:pl-6 py-3">
            <div className="relative mx-auto flex items-center justify-between text-blue-gray-900">
                <IconButton variant="text" size="md" onClick={openDrawer} className="">
